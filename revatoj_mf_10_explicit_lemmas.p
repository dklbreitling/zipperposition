...
thf(conj_0, conjecture,
    (((rev_a @ (cons_a @ a2 @ (cons_a @ b @ (cons_a @ c @ (cons_a @ d @ (cons_a @ e @ (cons_a @ f @ (cons_a @ g @ (cons_a @ h @ (cons_a @ i @ (cons_a @ j @ nil_a))))))))))) = (cons_a @ j @ (cons_a @ i @ (cons_a @ h @ (cons_a @ g @ (cons_a @ f @ (cons_a @ e @ (cons_a @ d @ (cons_a @ c @ (cons_a @ b @ (cons_a @ a2 @ nil_a))))))))))))).
